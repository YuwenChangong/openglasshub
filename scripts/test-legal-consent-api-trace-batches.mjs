...
assert.equal(new Set(completeTraceIds).size, 47);
assert.equal(expectedMethodCount - new Set(completeTraceIds).size, 19);
...
assert.equal(fileTraceProgress["src/pages/api/forum/external-video-upload.ts"]?.nextPendingMethodId, "src/pages/api/forum/media-upload-guard.ts#POST");
...
assert.equal(fileTraceProgress["src/pages/api/forum/comments.ts"]?.batch5Progress?.nextPendingMethodId, "src/pages/api/forum/media-upload-guard.ts#POST");
...
assert.equal(batch5?.methodIds.find((id) => !completeTraceIds.includes(id)), "src/pages/api/forum/media-upload-guard.ts#POST");
