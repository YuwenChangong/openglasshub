...
assert.equal(new Set(completeTraceIds).size, 45);
assert.equal(expectedMethodCount - new Set(completeTraceIds).size, 21);
...
assert.equal(batch5?.methodIds.find((id) => !completeTraceIds.includes(id)), "src/pages/api/forum/comments.ts#DELETE");
