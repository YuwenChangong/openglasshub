...
assert.equal(fileTraceProgress["src/pages/api/forum/external-video-upload.ts"]?.runtimeRemediationStatus, "implemented-awaiting-post-reaudit");
...
assert.equal(fileTraceProgress["src/pages/api/forum/external-video-upload.ts"]?.reAuditRequired, true);
