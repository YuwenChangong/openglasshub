...
export const R6_PAGES_CURRENT_CANONICAL_PRODUCTION_V3_TERMINAL_VERSION = "r6-pages-current-canonical-production-v3-metadata-terminal-result-v2";
...
export function validateCurrentCanonicalProductionV3TerminalResult(value, { resultPath, toolingCommit } = {}) {
  ...
  if (value.outerClassification === R6_PAGES_CURRENT_CANONICAL_PRODUCTION_V3_SUCCESS) {
    if (value.childExitCode !== 0 || value.innerClassification !== null || !phases.every((key) => value[key]) || value.commands.length !== 2) fail("R6_PAGES_CURRENT_CANONICAL_PRODUCTION_V3_TERMINAL_CONTRACT_UNSAFE");
