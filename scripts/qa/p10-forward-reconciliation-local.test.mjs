...
test("P10LOCAL-01 accepts reconciliation and receipt fixture gates", () => {
  assert.equal(validateP10LocalEvidence({ productionShaped: "PASS", alreadyCanonical: "PASS", rollback: "PASS", receiptHistoryAbsent: "PASS", receiptHistoryPresent: "PASS", sentinel: "PASS", productionConnections: 0, productionMutations: 0, cleanup: "PASS" }), "PASS");
});
