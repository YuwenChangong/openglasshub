...
export async function runP10ForwardReconciliationLocal() {
  ...
  const evidence = { productionShaped: "FAIL", alreadyCanonical: "FAIL", rollback: "FAIL", productionConnections: 0, productionMutations: 0, cleanup: "FAIL" };
  try {
