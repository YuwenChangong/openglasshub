...
assert.equal(
  expected.canonicalMigrationCount,
  expected.localMigrationLedger.length,
  "expected fingerprint scope may advance only when a genuine local replay advances its ledger",
);
