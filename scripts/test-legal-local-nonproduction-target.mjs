...
reject((binding) => { binding.identityEvidenceVariableName = "QA_DATABASE_URL"; }, "R6_NONPRODUCTION_TARGET_BINDING_UNKNOWN_FIELD");
reject((binding) => { binding.testOnly = true; }, "R6_NONPRODUCTION_TARGET_BINDING_UNKNOWN_FIELD");
...
console.log(JSON.stringify({ classification: "R6_LOCAL_NONPRODUCTION_TARGET_CONTRACT_TESTS_READY", fixtures: 11, realOperations: 0 }));
