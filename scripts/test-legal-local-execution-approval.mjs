...
const implementationCommit = execFileSync("git", ["rev-parse", "HEAD"], { cwd: process.cwd(), encoding: "utf8" }).trim();
const base = { implementationCommit, taskId: "r6-local-predeployment-aaaaaaaa-bbbb-4ccc-8ddd-eeeeeeeeeeee", migrationInventorySha256: "3d801ed1f10d84ccfb0f8ee2ee73e81a90e0a2b3955f75c4e91ed98c1520350a", issuedAt: "2026-08-06T00:00:00.000Z" };
