...
assert.equal(types.includes("aliases: string[] | null;"), false, "installed Wrangler 4.106.0 does not establish aliases=null as a verified deployment-response variant");
assert.equal(types.includes("commit_dirty"), false, "commit_dirty is not part of the proven response model");
console.log("PAGES_DEPLOYMENT_GET_SOURCE_CONTRACT_OK installed Wrangler 4.106.0 proves fixed GET, project/env/cache account-source precedence, a non-null aliases contract, and the minimum sufficient response fields only");
