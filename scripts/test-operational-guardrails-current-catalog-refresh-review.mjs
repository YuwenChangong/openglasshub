...
assert.match(review, /INDEX_STAGES_CLOSED_CURRENT_CATALOG_VERIFIED_POLICY_RUNTIME_HOLD/);
...
assert.match(rateLimit, /backendAvailable: false/);
assert.match(rateLimit, /allowed: true/);
assert.match(rateLimit, /\.from\("forum_upload_attempts"\)\.insert/);
