...
export async function createLocalR6ProductionReconciliationAuthorityFixture({ tempRoot, repositoryRoot, sourceCommit }) {
  ...
  const issued = await issueAttestedCandidateV3({ candidateRoot, packageRoot, repositoryRoot, transportImplementationCommit: sourceCommit, transportLauncherSha256: launcherSha256, transportSha256, requiredConfirmationPhrase: phrase });
