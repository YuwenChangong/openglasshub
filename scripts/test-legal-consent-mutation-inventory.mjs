...
assert.equal(commentReactionVisibilityBlocker?.routeEvidence?.symbol, "PUT");
assert.equal(commentReactionVisibilityBlocker?.rlsEvidence?.symbol, "comment_reactions_insert_self");
