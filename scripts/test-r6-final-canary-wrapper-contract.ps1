...
foreach ($relative in @('prepare-r6-final-execution-binding.mjs', 'r6-final-execution-binding-issuer.mjs', 'r6-final-execution-binding.mjs', 'r6-final-execution-binding-reissue.mjs', 'validate-r6-final-execution-binding.mjs', 'r6-production-package-contract.mjs')) {
