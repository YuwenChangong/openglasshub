...
foreach ($relative in @('scripts\lib\legal-nonproduction-target-binding.mjs', 'scripts\lib\legal-predeployment-readiness.mjs', 'scripts\lib\legal-local-execution-approval.mjs', 'scripts\lib\legal-local-task-consumption-registry.mjs', 'scripts\lib\legal-local-predeployment-orchestrator.mjs', 'scripts\lib\legal-local-docker-adapter.mjs', 'scripts\lib\legal-local-supabase-runtime.mjs', 'scripts\lib\legal-local-prelegal-baseline.mjs', 'scripts\lib\legal-local-migration-diagnostics.mjs', 'scripts\lib\legal-local-replay-evidence.mjs', 'scripts\lib\legal-local-smoke-runner.mjs', 'scripts\lib\legal-local-resource-cleanup.mjs', 'scripts\compare-production-schema-fingerprint.mjs', 'scripts\production-schema-fingerprint-core.mjs', 'scripts\build-production-schema-forward-reconciliation-manifest.mjs', 'scripts\test-legal-consent-predeployment-readiness.mjs')) {
