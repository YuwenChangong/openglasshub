...
foreach ($relative in @('scripts\lib\legal-nonproduction-target-binding.mjs', 'scripts\lib\legal-local-predeployment-orchestrator.mjs', 'scripts\lib\legal-local-docker-adapter.mjs', 'scripts\lib\legal-local-replay-evidence.mjs', 'scripts\lib\legal-local-smoke-runner.mjs', 'scripts\lib\legal-local-resource-cleanup.mjs', 'scripts\test-legal-consent-predeployment-readiness.mjs')) {
