...
| `operational-guardrails-rate-limit-r3-simulation-readiness.md` | Explicit R3 preconditions. | R3 eligible only with separate approval. |
...
decisions are closed. It remains unexecuted; R3 needs separate approval for a
disposable local database simulation, and Stage C remains blocked pending a
runtime migration.
