-- UNEXECUTED R6-6 recovery. One read-only catalog statement, one compact row.
-- The offline validator compares the returned protected fingerprints to the
-- operator-held R6-2 baseline. This statement never reads application rows.
