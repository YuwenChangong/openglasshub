...
export const fileTraceProgress = {
  "src/pages/api/forum/comments.ts": {
    ...
    blockedMethodId: "src/pages/api/forum/comments.ts#POST",
    blockedMethodBatchId: "phase4a1-trace-batch-4",
    routeEvidenceSource: "src/pages/api/forum/comments.ts#POST",
    rlsEvidenceSource: "supabase/migrations/20260616_community_moderation_mvp.sql#comments_insert_self",
