...
export const r2ExecutionStatus = {
  ...
  productionIdentity: "PRODUCTION_BINDING_METADATA_READY_R6_SCOPE_BLOCKED",
  unresolvedDecisions: [],
  remainingDeploymentPrerequisites: ["production_function_owner_confirmation", "r6_raw_client_boundary_remediation"],
